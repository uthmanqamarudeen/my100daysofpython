...
timer_label = Label(text="Timer", font=(FONT_NAME, 35, "bold"), bg=YELLOW, fg=GREEN, pady=5)
timer_label.grid(column=1, row=0)

tomato_img = PhotoImage(file="tomato.png")
canvas = Canvas(width=200, height=224, bg=YELLOW, highlightthickness=0)
canvas.create_image(100, 112, image=tomato_img)
timer_text = canvas.create_text(107, 130, text="00:00", fill="white", font=(FONT_NAME, 29, "bold"))
...
checkmark_text = ""
checkmark_label = Label(text=checkmark_text, fg=GREEN, bg=YELLOW, font=(FONT_NAME, 10, "bold"))
